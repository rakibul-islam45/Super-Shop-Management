...
-- distributed transaction and XA support for the Microsoft JDBC Driver 6.4 for SQL Server.
...
-- in Microsoft JDBC Driver 6.4 for SQL Server distributed transactions.
